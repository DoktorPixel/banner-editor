...
const AutoSaver = () => {
    const { objects, dynamicImgs, currentProjectName, currentProjectId } = useBanner();
    ...
    const debouncedSave = useMemo(() => debounce(saveData, 1000, { leading: false, trailing: true }), [saveData]);
    useEffect(() => {
