...
const API_URL = "https://tgitxrjsbuimawihmkth.supabase.co/functions/v1/templates/uploadPreview";
export const captureAndUploadPreview = async (templateId) => {
    const element = document.querySelector(".banner-area");
    if (!element) {
