...
import { TextField, Box, Button, MenuItem, Select, Typography, ButtonGroup, InputLabel, InputAdornment, IconButton, } from "@mui/material";
...
import { BorderBottom, BorderLeft, BorderRight, BorderTop, MinusIcon, PlusIcon, } from "../../../assets/icons";
import { useTranslation } from "react-i18next";
export const FigureChildObjectForm = ({ object, onChange, onChangeMultiple, }) => {
    ...
    return (_jsxs(Box, { children: [_jsx(Typography, { variant: "subtitle1", className: "padding-wrapper", sx: { mb: 1 }, children: t("sidebar.nestedFigure") }), _jsx("div", { className: "grey-line" }), _jsx(ChildConditionSelector, { childId: object.id, condition: object.condition }), _jsx("div", { className: "grey-line" }), _jsxs("div", { className: "padding-wrapper", children: [_jsx(Typography, { variant: "subtitle2", children: t("sidebar.layouts") }), _jsx(InputLabel, { sx: { mt: 1, mb: -2, fontSize: "12px" }, children: t("sidebar.size") }), _jsxs("div", { className: "auto-size", children: [_jsx(TextField, { slotProps: {
                                    input: {
                                ...
                                }, fullWidth: true, margin: "normal" })] }), _jsx("div", { className: "auto-size", style: { width: "calc(50% - 5px)" }, children: _jsx(TextField, { label: t("sidebar.rotate"), type: "number", value: object.rotate || 0, onChange: (e) => onChange("rotate", parseInt(e.target.value, 10)), fullWidth: true, margin: "normal" }) })] }), _jsx("div", { className: "grey-line" }), _jsx("div", { className: "padding-wrapper", children: _jsx(Box, { children: object.backgroundColor && object.backgroundColor !== "none" ? (_jsxs("div", { children: [_jsxs(Box, { display: "flex", alignItems: "center", justifyContent: "space-between", children: [_jsx(Typography, { variant: "subtitle2", children: t("sidebar.backgroundColor") }), _jsx(IconButton, { onClick: () => {
