...
import { BorderBottom, BorderLeft, BorderRight, BorderTop, ArrowRight1, ArrowDown1, PaddingLeft, PaddingRight, PaddingTop, PaddingBottom, MinusIcon, PlusIcon, } from "../../../assets/icons";
...
export const GroupChildObjectForm = ({ object, onChange, onChangeMultiple, }) => {
    ...
    const { selectedChild, handleChangeMultipleChildProperties } = useChildProperties();
    ...
    return (_jsxs(Box, { className: "child-object-form", children: [_jsx(Typography, { variant: "subtitle1", className: "padding-wrapper", sx: { mb: 1 }, children: t("sidebar.nestedLayout") }), _jsx("div", { className: "grey-line" }), _jsx(ChildConditionSelector, { childId: object.id, condition: object.condition }), _jsx("div", { className: "grey-line" }), _jsxs("div", { className: "padding-wrapper", children: [_jsxs(Typography, { variant: "subtitle2", children: [" ", t("sidebar.layouts")] }), _jsx(InputLabel, { sx: { mt: 1, mb: -2, fontSize: "12px" }, children: t("sidebar.size") }), _jsxs("div", { className: "auto-size", children: [_jsx(TextField, { slotProps: {
                                ...
                                { value: "fixed", label: t("sidebar.fixed") },
                                    ...
                                    ], selected: object.flexDirection, onChange: (value) => onChange("flexDirection", value) }) }), _jsx("div", { children: _jsx("div", { style: { maxWidth: "196px" }, children: _jsx(ChildActionToggleMultiple, { value: object.gap, onChangeMultiple: onChangeMultiple }) }) })] }), _jsx(InputLabel, { sx: { mt: 1, mb: "2px", fontSize: "12px" }, children: t("sidebar.alignment") }), _jsx(AutoLayoutForm, { flexDirection: selectedChild?.flexDirection ?? "row", justifyContent: selectedChild?.justifyContent ?? "center", alignItems: selectedChild?.alignItems ?? "center", onChange: (changes) => handleChangeMultipleChildProperties(changes) }), _jsxs("div", { children: [_jsx(InputLabel, { sx: { mt: 1, mb: "2px", fontSize: "12px" }, children: t("sidebar.padding") }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "7px" }, children: [_jsxs("div", { style: {
                                            display: "flex",
                                            flexDirection: "row",
                                            gap: "7px",
                                            maxWidth: "250px",
